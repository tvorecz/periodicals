...
public class ResultHandlerRepositoryImpl implements ResultHandlerRepository {
    ...
    private ResultHandlerRepositoryImpl() {
        ...
        repository.put(HandlerType.SCALAR, new ScalarResultHandler());
        ...
        repository.put(HandlerType.ALL_SUBSCRIPTION_TYPES, new SubscriptionTypesResultHandler());
        ...
        repository.put(HandlerType.SEARCH_PERIODICAL, new SearchPeriodicalResultHandler());
    }
